...
if __name__ == "__main__":
    ...
    "rescueDate": datetime(2024, 12, 10),
    ...
    #pet_db.read_pets({'_id': ObjectId('68445db88e8cb8948f45c4d8')})

    #pet_db.delete_pet({'_id': ObjectId('68445db88e8cb8948f45c4d8')})
    #pet_db.read_pets({'_id': ObjectId('68445db88e8cb8948f45c4d8')})
    #print("\n One pet document:")
    ...
    #pet_db.is_ready_for_adoption(ObjectId('68443956e27404c54b907570'))
